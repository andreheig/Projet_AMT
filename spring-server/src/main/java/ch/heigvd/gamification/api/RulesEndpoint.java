...
public class RulesEndpoint implements RulesApi {
  ...
  @Override
  public ResponseEntity<List<ApplicationsRulesSummary>> findApplicationRules(@ApiParam(value = "uuid de l'application à trouver",required=true ) @PathVariable("uuid") String uuid){
  ...
  @Override
  public ResponseEntity<Void> postRule(@ApiParam(value = "uuid of the application to add rule",required=true ) @PathVariable("uuid") String uuid,
  ...
  @Override
  public ResponseEntity<Void> updateRule(@ApiParam(value = "uuid of the application to update rule",required=true ) @PathVariable("uuid") String uuid,
