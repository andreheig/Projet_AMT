...
INSERT INTO Application (id, name, keyUUID, secretUUID) VALUES (1,'FPS', '06068b82-d91a-8888-5b39-cd4adb07ae27', 'b7197d93-e3ab-f2ac-e4ac-6e3362289fdc');
...
INSERT INTO EndUser (id, idInGamifiedApplication, app_id, name, numberOfEvents) VALUES (1, '90011445-4354-4aff-8863-d55598867884', 1, 'Aladin', 0);
-- Permet de rentrer des badges:
INSERT INTO Badge (id, app_id, name) VALUES (1, 1, 'beginner');
-- Permet de rentrer des échelles:
INSERT INTO Scale (id, app_id, max, name) VALUES (1, 1, 10000, 'Killpoints');
-- Point rules: what event awards how many point
INSERT INTO PointRule (id, app_id, name, scale_id, eventtype, defaultNbPoints) VALUES (1, 1, 'Killing rule', 1, 'kill',100);
-- Threshold rule: with how many points a badge is won
INSERT INTO BadgeThresholdRule (id, app_id, name, scale_id, badge_id, threshold) VALUES (1, 1, 'Beginner killer rule', 1, 1, 200);
