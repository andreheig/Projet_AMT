...
INSERT INTO Application (id, name, keyUUID, secretUUID, version) VALUES (1,'Vélo', '06068b82-d91a-8888-5b39-cd4adb07ae27', 'b7197d93-e3ab-f2ac-e4ac-6e3362289fdc', 0);
INSERT INTO Application (id, name, keyUUID, secretUUID, version) VALUES (2,'stackOverflow', '4432ae66-f995-f10f-6b14-962a8429b41f', '9b4a75ec-8af2-67ff-bf85-321f4170e585', 0);
INSERT INTO Application (id, name, keyUUID, secretUUID, version) VALUES (3,'filmovore', 'e55e4dca-461e-c80f-8a88-a994ec1c381c', '2b19184e-aca3-acf6-f6f2-0c23b37a49ba', 0);
INSERT INTO Application (id, name, keyUUID, secretUUID, version) VALUES (4,'eleifend vitae, erat.', '601262e1-7d3d-84fd-6e82-aa243252ae81', 'be722e5f-b7a5-ced3-d8ee-b489d6b5bdaa', 0);
/*-- Permet de rentrer des badges:
INSERT INTO Badge (id, name, version) VALUES (1, 'beginner', 0);
INSERT INTO Badge (id, name, version) VALUES (2, 'medium', 0);
INSERT INTO Badge (id, name, version) VALUES (3, 'expert', 0);
INSERT INTO Badge (id, name, version) VALUES (4, 'beginner', 0);
INSERT INTO Badge (id, name, version) VALUES (5, 'medium', 0);
INSERT INTO Badge (id, name, version) VALUES (6, 'expert', 0);
-- Permet de lier les Badges à une app:
...
INSERT INTO Scale (id, max, name, version) VALUES (1, 10000, 'Kilomètres', 0);
INSERT INTO Scale (id, max, name, version) VALUES (2, 10000, 'Films', 0);
-- Permet de lier les échelles à une app:
...
-- Permet de lier une règle à une app:
...
-- PErmet d'entrer le nombre de points d'users sur des scles
INSERT INTO UserScale (user_id, scale_id, nbPoints) VALUES (1, 1, 0);
INSERT INTO PointRule (id, name, eventType, badge, defaultnbPoints) = (1, 'rule', 'sortie', 1, 100)*/
